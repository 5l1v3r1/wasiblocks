    ...
    return (
      <div className={`app${darkMode ? ' dark-mode' : ''}${sidebar ? ' has-sidebar' : ''} ${theme} ${view}`}>
        ...
        <div className="toolbar">
          <button className="opener" onClick={this.toggleSidebar} ref={this.openerRef}>Hackerwasi</button>
          {this.state.codeView &&
        ...
        <a href="https://github.com/mertJF/Hackerwasi" className="github" target="_blank" rel="noopener noreferrer">
